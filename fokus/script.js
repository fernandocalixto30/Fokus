...
if(focoAtivo){
  ...
  mostraTEmpo();
  console.log(tempoDecoridoemSegundos);
};
...
function IniciarouPausar() {
  ...
  intervaloId = setInterval(contagenRegreciva, 1000);
}
function zerar() {
...
function mostraTEmpo() {
  ...
  const tempoFormatedo = tempo.toLocaleString("pt-br", {
    minute: "2-digit",
    second: "2-digit",
  });
  tempoNaTela.innerHTML = `${tempoFormatedo}`;
}
mostraTEmpo();